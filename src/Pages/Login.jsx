                ...
                <div style={{height:'85%'}} className="bg-white w-2/3 h- grid lg:grid-cols-2 overflow-auto rounded-tr-3xl rounded-bl-3xl">
                    <div className="m-5   flex flex-col align-middle text-center">
                        ...
                        <div className='flex items-center'>
                            ...
                            <span className="text-sm text-light mt-1 mr-2 ml-2">Login To Your Account</span>
                            <hr className="flex-grow border-[1px]"/>
                        </div>
                        <form className='pt-2 mt-20'>
                                ...
                                onClick={async(e)=>{
                                    ...
                                    if(email,pass){
                                        try{
                                            ...
                                            const data=await axios.post('https://xeroo.onrender.com/api/v1/login',
                        ...
                        <a href="https://xeroo.onrender.com/api/v1/login/google">
                            ...
                            >
                                Login With Google <img src={image1}/>
                            </button></a>
                            ...
                            >
                                Login With GitHub<img src={image2}/>
                            </button></a>
                        </div>
                        <div className='text-gg text-sm'>Don't  have a account? <Link to="/signup" className='text-blue-600'>SIGNUP</Link>
                        </div>
                    </div>
